...
AFL ladder and fixtures snapshot from the Squiggle API.
...
Produces `afl.vzglyd` — a packaged slide ready to be placed in your VZGLYD slides directory.

## Sidecar

This slide consumes data from [`lume-afl-sidecar`](https://github.com/lume-industries/lume-afl-sidecar).
